...
public class Tablero {
    ...
    private void Inicializar() {
        ...
        Casilla casillaCalle1 = new Calle(1, tituloPropiedadCalle1);
        ...
        Casilla casillaCalle2 = new Calle(2, tituloPropiedadCalle2);
        ...
        Casilla casillaCalle3 = new Calle(3, tituloPropiedadCalle3);
        casillas.add(casillaCalle3);
        
        TituloPropiedad tituloPropiedadCalle4 = new TituloPropiedad("Barrio Alto", 565, 402, 10.0f, 50, 200);
        Casilla casillaCalle4 = new Calle(4, tituloPropiedadCalle4);
        casillas.add(casillaCalle4);
        
        Casilla casillaCarcel = new OtraCasilla(5, TipoCasilla.CARCEL);
        ...
        Casilla casillaCalle6 = new Calle(6, tituloPropiedadCalle6);
        casillas.add(casillaCalle6);
        
        Casilla casillaSorpresa = new OtraCasilla(7, TipoCasilla.SORPRESA);
        ...
        Casilla casillaCalle8 = new Calle(8, tituloPropiedadCalle8);
        ...
        Casilla casillaCalle9 = new Calle(9, tituloPropiedadCalle9);
        casillas.add(casillaCalle9);
        
        Casilla casillaParking = new OtraCasilla(10, TipoCasilla.PARKING);
        casillas.add(casillaParking);
        
        TituloPropiedad tituloPropiedadCalle11 = new TituloPropiedad("Alcazaba", 814, 670, 20.0f, 75, 650);
        Casilla casillaCalle11 = new Calle(11, tituloPropiedadCalle11);
        casillas.add(casillaCalle11);
        
        Casilla casillaImpuesto = new OtraCasilla(12, TipoCasilla.IMPUESTO);
        casillas.add(casillaImpuesto);
        
        Casilla casillaSorpresa2 = new OtraCasilla(13, TipoCasilla.SORPRESA);
